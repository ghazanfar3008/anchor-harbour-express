    ...
    <div className="bg-navy-deep text-paper font-sans selection:bg-anchor-blue selection:text-white min-h-screen">
      ...
      <section className="pt-40 pb-24 px-8 md:px-20 border-b border-white/5">
        ...
        <h1 className="text-5xl md:text-7xl font-heading font-black tracking-tight leading-[0.95] max-w-4xl">
          Logistics solutions across <span className="text-anchor-blue font-black tracking-tight">air, sea and land.</span>
        </h1>
      ...
      <section className="bg-paper text-navy px-8 md:px-20 py-20">
        <div className="grid md:grid-cols-2 gap-1">
          {services.map((s, i) => (
            <article key={s.t} className="group relative bg-white border border-navy/5 p-10 hover:bg-navy hover:text-white transition-all duration-500 overflow-hidden">
              <span className="absolute -right-4 -top-8 text-[10rem] font-heading font-light opacity-[0.04] group-hover:opacity-10 transition-opacity">
        ...
        <div className="mt-20 text-center">
          <h3 className="font-heading font-bold tracking-tight text-3xl md:text-4xl mb-6">Not sure which service fits your cargo?</h3>
